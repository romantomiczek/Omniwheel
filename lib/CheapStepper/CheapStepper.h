...
public:
	...
	void move(float RPM, bool direction);

	void setRpm(float rpm); // sets speed (10-24 rpm, hi-low torque)
...
private:
	int calcDelay(float rpm); // calcs microsecond step delay for given rpm
